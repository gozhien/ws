...
wget -P /etc/systemd/system/ https://raw.githubusercontent.com/gozhien/ws/main/nodews.service
cd /etc && mkdir fas && cd fas && wget https://raw.githubusercontent.com/gozhien/ws/main/proxy3.js && cd $home
